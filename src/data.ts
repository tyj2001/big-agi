...
export const SystemPurposes: { [key in SystemPurposeId]: SystemPurposeData } = {
  Developer: {
    ...
    symbol: '👩‍💻',
    examples: [t('hello world in 10 languages'), t('translate python to typescript'), t('find and fix a bug in my code'), t('add a mic feature to my NextJS app'), t('automate tasks in React')],
  },
  Scientist: {
    title: t('Scientist'),
    ...
    symbol: '🔬',
    examples: [t('write a grant proposal on human AGI'), t('review this PDF with an eye for detail'), t('explain the basics of quantum mechanics'), t('how do I set up a PCR reaction?'), t('the role of dark matter in the universe')],
  },
  Catalyst: {
    title: t('Catalyst'),
    ...
    symbol: '🚀',
    examples: [t('blog post on AGI in 2024'), t('add much emojis to this tweet'), t('overcome procrastination!'), t('how can I improve my communication skills?')],
  },
  Executive: {
    title: t('Executive'),
    ...
    symbol: '👔',
    examples: [t('draft a letter to the board'), t('write a memo to the CEO'), t('help me with a SWOT analysis'), t('how do I team build?'), t('improve decision-making')],
  },
  Designer: {
    title: t('Designer'),
    ...
    symbol: '🖌️',
    examples: [t('minimalist logo for a tech startup'), t('infographic on climate change'), t('suggest color schemes for a website')],
  },
  Generic: {
    title: t('Default'),
    ...
    symbol: '🧠',
    examples: [t('help me plan a trip to Japan'), t('what is the meaning of life?'), t('how do I get a job at OpenAI?'), t('what are some healthy meal ideas?')],
  },
  Custom: {
    title: t('Custom'),
